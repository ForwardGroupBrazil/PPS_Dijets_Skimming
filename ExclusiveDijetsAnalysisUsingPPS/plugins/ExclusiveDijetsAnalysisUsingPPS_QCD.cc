// -*- C++ -*-
//
// Package:    ExclusiveDijetsAnalysisUsingPPS_QCD
// Class:      ExclusiveDijetsAnalysisUsingPPS_QCD
//
...
class ExclusiveDijetsAnalysisUsingPPS_QCD : public edm::EDAnalyzer {
  public:
    explicit ExclusiveDijetsAnalysisUsingPPS_QCD(const edm::ParameterSet&);
    ~ExclusiveDijetsAnalysisUsingPPS_QCD();
  ...
  private:
    ...
    //////////////////
    //Signal + Signal
    std::vector<double>   xPPSArmBToFInfo_00;
    std::vector<double>   yPPSArmBToFInfo_00;

    std::vector<double>	xPPSArmFToFInfo_00;
    std::vector<double>    yPPSArmFToFInfo_00;

    std::vector<double>	xPPSArmBDet2Info_00;
    std::vector<double>     yPPSArmBDet2Info_00;

    std::vector<double>	xPPSArmFDet2Info_00;
    std::vector<double>	yPPSArmFDet2Info_00;

    std::vector<double>	xPPSArmBDet1Info_00;
    std::vector<double>	yPPSArmBDet1Info_00;

    std::vector<double>	xPPSArmFDet1Info_00;
    std::vector<double>	yPPSArmFDet1Info_00;

    std::vector<double>	tPPSArmFInfo_00;
    std::vector<double>	tPPSArmBInfo_00;

    std::vector<double>	xiPPSArmFInfo_00;
    std::vector<double>	xiPPSArmBInfo_00;
    ////////////////////////////////////////////////
    // Signal + PU
    std::vector<double>   xPPSArmBToFInfo_0i;
    std::vector<double>   yPPSArmBToFInfo_0i;

    std::vector<double>    xPPSArmFToFInfo_0i;
    std::vector<double>    yPPSArmFToFInfo_0i;

    std::vector<double>     xPPSArmBDet2Info_0i;
    std::vector<double>     yPPSArmBDet2Info_0i;

    std::vector<double>     xPPSArmFDet2Info_0i;
    std::vector<double>     yPPSArmFDet2Info_0i;

    std::vector<double>     xPPSArmBDet1Info_0i;
    std::vector<double>     yPPSArmBDet1Info_0i;

    std::vector<double>     xPPSArmFDet1Info_0i;
    std::vector<double>     yPPSArmFDet1Info_0i;

    std::vector<double>     tPPSArmFInfo_0i;
    std::vector<double>     tPPSArmBInfo_0i;

    std::vector<double>     xiPPSArmFInfo_0i;
    std::vector<double>     xiPPSArmBInfo_0i;
    //////////////////////////////////////////////////
    // PU + PU

    std::vector<double>   xPPSArmBToFInfo_ii;
    std::vector<double>   yPPSArmBToFInfo_ii;

    std::vector<double>    xPPSArmFToFInfo_ii;
    std::vector<double>    yPPSArmFToFInfo_ii;

    std::vector<double>     xPPSArmBDet2Info_ii;
    std::vector<double>     yPPSArmBDet2Info_ii;

    std::vector<double>     xPPSArmFDet2Info_ii;
    std::vector<double>     yPPSArmFDet2Info_ii;

    std::vector<double>     xPPSArmBDet1Info_ii;
    std::vector<double>     yPPSArmBDet1Info_ii;

    std::vector<double>     xPPSArmFDet1Info_ii;
    std::vector<double>     yPPSArmFDet1Info_ii;

    std::vector<double>     tPPSArmFInfo_ii;
    std::vector<double>     tPPSArmBInfo_ii;

    std::vector<double>     xiPPSArmFInfo_ii;
    std::vector<double>     xiPPSArmBInfo_ii;
    ///////////////////////////////////////////////////////
    std::vector<double>  stopPPSArmFToFInfo_00;
    std::vector<double>  stopPPSArmBToFInfo_00;

    std::vector<double>  stopPPSArmFTrkDet1Info_00;
    std::vector<double>  stopPPSArmFTrkDet2Info_00;
    std::vector<double>  stopPPSArmBTrkDet1Info_00;
    std::vector<double>  stopPPSArmBTrkDet2Info_00;




    std::vector<double>  stopPPSArmFToFInfo_0i;
    std::vector<double>  stopPPSArmBToFInfo_0i;

    std::vector<double>  stopPPSArmFTrkDet1Info_0i;
    std::vector<double>  stopPPSArmFTrkDet2Info_0i;
    std::vector<double>  stopPPSArmBTrkDet1Info_0i;
    std::vector<double>  stopPPSArmBTrkDet2Info_0i;





    std::vector<double>  stopPPSArmFToFInfo_ii;
    std::vector<double>  stopPPSArmBToFInfo_ii;

    std::vector<double>  stopPPSArmFTrkDet1Info_ii;
    std::vector<double>  stopPPSArmFTrkDet2Info_ii;
    std::vector<double>  stopPPSArmBTrkDet1Info_ii;
    std::vector<double>  stopPPSArmBTrkDet2Info_ii;
...
ExclusiveDijetsAnalysisUsingPPS_QCD::ExclusiveDijetsAnalysisUsingPPS_QCD(const edm::ParameterSet& iConfig):
  ...
  EBeam_(iConfig.getParameter<double>("EBeam"))
{
  ...
  // Sigan + Signal
  eventTree_->Branch("xPPSArmBToFInfo_00",&xPPSArmBToFInfo_00);
  eventTree_->Branch("yPPSArmBToFInfo_00",&yPPSArmBToFInfo_00);

  eventTree_->Branch("xPPSArmFToFInfo_00",&xPPSArmFToFInfo_00);
  eventTree_->Branch("yPPSArmFToFInfo_00",&yPPSArmFToFInfo_00);

  eventTree_->Branch("xPPSArmBDet2Info_00",&xPPSArmBDet2Info_00); 
  eventTree_->Branch("yPPSArmBDet2Info_00",&yPPSArmBDet2Info_00);

  eventTree_->Branch("xPPSArmFDet2Info_00",&xPPSArmFDet2Info_00);
  eventTree_->Branch("yPPSArmFDet2Info_00",&yPPSArmFDet2Info_00);

  eventTree_->Branch("xPPSArmBDet1Info_00",&xPPSArmBDet1Info_00);
  eventTree_->Branch("yPPSArmBDet1Info_00",&yPPSArmBDet1Info_00);

  eventTree_->Branch("xPPSArmFDet1Info_00",&xPPSArmFDet1Info_00);
  eventTree_->Branch("yPPSArmFDet1Info_00",&yPPSArmFDet1Info_00);

  eventTree_->Branch("tPPSArmFInfo_00",&tPPSArmFInfo_00);
  eventTree_->Branch("xiPPSArmFInfo_00",&xiPPSArmFInfo_00);    

  eventTree_->Branch("tPPSArmBInfo_00",&tPPSArmBInfo_00);
  eventTree_->Branch("xiPPSArmBInfo_00",&xiPPSArmBInfo_00);


  // S + PU
  eventTree_->Branch("xPPSArmBToFInfo_0i",&xPPSArmBToFInfo_0i);
  eventTree_->Branch("yPPSArmBToFInfo_0i",&yPPSArmBToFInfo_0i);

  eventTree_->Branch("xPPSArmFToFInfo_0i",&xPPSArmFToFInfo_0i);
  eventTree_->Branch("yPPSArmFToFInfo_0i",&yPPSArmFToFInfo_0i);

  eventTree_->Branch("xPPSArmBDet2Info_0i",&xPPSArmBDet2Info_0i);
  eventTree_->Branch("yPPSArmBDet2Info_0i",&yPPSArmBDet2Info_0i);

  eventTree_->Branch("xPPSArmFDet2Info_0i",&xPPSArmFDet2Info_0i);
  eventTree_->Branch("yPPSArmFDet2Info_0i",&yPPSArmFDet2Info_0i);

  eventTree_->Branch("xPPSArmBDet1Info_0i",&xPPSArmBDet1Info_0i);
  eventTree_->Branch("yPPSArmBDet1Info_0i",&yPPSArmBDet1Info_0i);

  eventTree_->Branch("xPPSArmFDet1Info_0i",&xPPSArmFDet1Info_0i);
  eventTree_->Branch("yPPSArmFDet1Info_0i",&yPPSArmFDet1Info_0i);

  eventTree_->Branch("tPPSArmFInfo_0i",&tPPSArmFInfo_0i);
  eventTree_->Branch("xiPPSArmFInfo_0i",&xiPPSArmFInfo_0i);

  eventTree_->Branch("tPPSArmBInfo_0i",&tPPSArmBInfo_0i);
  eventTree_->Branch("xiPPSArmBInfo_0i",&xiPPSArmBInfo_0i);

  ////////// ii

  eventTree_->Branch("xPPSArmBToFInfo_ii",&xPPSArmBToFInfo_ii);
  eventTree_->Branch("yPPSArmBToFInfo_ii",&yPPSArmBToFInfo_ii);

  eventTree_->Branch("xPPSArmFToFInfo_ii",&xPPSArmFToFInfo_ii);
  eventTree_->Branch("yPPSArmFToFInfo_ii",&yPPSArmFToFInfo_ii);

  eventTree_->Branch("xPPSArmBDet2Info_ii",&xPPSArmBDet2Info_ii);
  eventTree_->Branch("yPPSArmBDet2Info_ii",&yPPSArmBDet2Info_ii);

  eventTree_->Branch("xPPSArmFDet2Info_ii",&xPPSArmFDet2Info_ii);
  eventTree_->Branch("yPPSArmFDet2Info_ii",&yPPSArmFDet2Info_ii);

  eventTree_->Branch("xPPSArmBDet1Info_ii",&xPPSArmBDet1Info_ii);
  eventTree_->Branch("yPPSArmBDet1Info_ii",&yPPSArmBDet1Info_ii);

  eventTree_->Branch("xPPSArmFDet1Info_ii",&xPPSArmFDet1Info_ii);
  eventTree_->Branch("yPPSArmFDet1Info_ii",&yPPSArmFDet1Info_ii);

  eventTree_->Branch("tPPSArmFInfo_ii",&tPPSArmFInfo_ii);
  eventTree_->Branch("xiPPSArmFInfo_ii",&xiPPSArmFInfo_ii);

  eventTree_->Branch("tPPSArmBInfo_ii",&tPPSArmBInfo_ii);
  eventTree_->Branch("xiPPSArmBInfo_ii",&xiPPSArmBInfo_ii);

  //////

  eventTree_->Branch("stopPPSArmFToFInfo_00",&stopPPSArmFToFInfo_00);
  eventTree_->Branch("stopPPSArmBToFInfo_00",&stopPPSArmBToFInfo_00);
  eventTree_->Branch("stopPPSArmFTrkDet1Info_00",&stopPPSArmFTrkDet1Info_00); 
  eventTree_->Branch("stopPPSArmFTrkDet2Info_00",&stopPPSArmFTrkDet2Info_00);  
  eventTree_->Branch("stopPPSArmBTrkDet1Info_00",&stopPPSArmBTrkDet1Info_00);  
  eventTree_->Branch("stopPPSArmBTrkDet2Info_00",&stopPPSArmBTrkDet2Info_00);  


  /////////
  eventTree_->Branch("stopPPSArmFToFInfo_0i",&stopPPSArmFToFInfo_0i);
  eventTree_->Branch("stopPPSArmBToFInfo_0i",&stopPPSArmBToFInfo_0i);
  eventTree_->Branch("stopPPSArmFTrkDet1Info_0i",&stopPPSArmFTrkDet1Info_0i);  
  eventTree_->Branch("stopPPSArmFTrkDet2Info_0i",&stopPPSArmFTrkDet2Info_0i);   
  eventTree_->Branch("stopPPSArmBTrkDet1Info_0i",&stopPPSArmBTrkDet1Info_0i); 
  eventTree_->Branch("stopPPSArmBTrkDet2Info_0i",&stopPPSArmBTrkDet2Info_0i);



  ///////////////////////////
  eventTree_->Branch("stopPPSArmFToFInfo_ii",&stopPPSArmFToFInfo_ii);
  eventTree_->Branch("stopPPSArmBToFInfo_ii",&stopPPSArmBToFInfo_ii);
  eventTree_->Branch("stopPPSArmFTrkDet1Info_ii",&stopPPSArmFTrkDet1Info_ii);
  eventTree_->Branch("stopPPSArmFTrkDet2Info_ii",&stopPPSArmFTrkDet2Info_ii);
...
ExclusiveDijetsAnalysisUsingPPS_QCD::~ExclusiveDijetsAnalysisUsingPPS_QCD()
{
}


// ------------ method called once each job just before starting event loop  ------------
void ExclusiveDijetsAnalysisUsingPPS_QCD::beginJob()
{
  cout << "\n--- P P S    C E P   A N A L Y Z E R---\n" << endl;
}

// ------------ method called once each job just after ending the event loop  ------------
void ExclusiveDijetsAnalysisUsingPPS_QCD::endJob()
{
...
void ExclusiveDijetsAnalysisUsingPPS_QCD::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup){
...
void ExclusiveDijetsAnalysisUsingPPS_QCD::Init(){


  stopPPSArmFToFInfo_00.clear();
  stopPPSArmBToFInfo_00.clear();
  stopPPSArmFTrkDet1Info_00.clear();
  stopPPSArmFTrkDet2Info_00.clear();
  stopPPSArmBTrkDet1Info_00.clear();
  stopPPSArmBTrkDet2Info_00.clear();




  stopPPSArmFToFInfo_0i.clear();
  stopPPSArmBToFInfo_0i.clear();
  stopPPSArmFTrkDet1Info_0i.clear();
  stopPPSArmFTrkDet2Info_0i.clear();
  stopPPSArmBTrkDet1Info_0i.clear();
  stopPPSArmBTrkDet2Info_0i.clear();



  stopPPSArmFToFInfo_ii.clear();
  stopPPSArmBToFInfo_ii.clear();
  stopPPSArmFTrkDet1Info_ii.clear();
  stopPPSArmFTrkDet2Info_ii.clear();
  stopPPSArmBTrkDet1Info_ii.clear();
  stopPPSArmBTrkDet2Info_ii.clear();
  ...
  //// 00///////
  xPPSArmBToFInfo_00.clear();
  yPPSArmBToFInfo_00.clear();

  xPPSArmFToFInfo_00.clear();
  yPPSArmFToFInfo_00.clear();


  xPPSArmBDet2Info_00.clear();
  yPPSArmBDet2Info_00.clear();

  xPPSArmFDet2Info_00.clear();
  yPPSArmFDet2Info_00.clear();

  xPPSArmBDet1Info_00.clear();
  yPPSArmBDet1Info_00.clear();

  xPPSArmFDet1Info_00.clear();
  yPPSArmFDet1Info_00.clear();

  tPPSArmFInfo_00.clear();
  tPPSArmBInfo_00.clear();

  xiPPSArmFInfo_00.clear();
  xiPPSArmBInfo_00.clear();

  //
  //// 0i///////
  xPPSArmBToFInfo_0i.clear();
  yPPSArmBToFInfo_0i.clear();

  xPPSArmFToFInfo_0i.clear();
  yPPSArmFToFInfo_0i.clear();


  xPPSArmBDet2Info_0i.clear();
  yPPSArmBDet2Info_0i.clear();

  xPPSArmFDet2Info_0i.clear();
  yPPSArmFDet2Info_0i.clear();

  xPPSArmBDet1Info_0i.clear();
  yPPSArmBDet1Info_0i.clear();

  xPPSArmFDet1Info_0i.clear();
  yPPSArmFDet1Info_0i.clear();

  tPPSArmFInfo_0i.clear();
  tPPSArmBInfo_0i.clear();

  xiPPSArmFInfo_0i.clear();
  xiPPSArmBInfo_0i.clear();

  ////////////////ii/////////
  xPPSArmBToFInfo_ii.clear();
  yPPSArmBToFInfo_ii.clear();

  xPPSArmFToFInfo_ii.clear();
  yPPSArmFToFInfo_ii.clear();


  xPPSArmBDet2Info_ii.clear();
  yPPSArmBDet2Info_ii.clear();

  xPPSArmFDet2Info_ii.clear();
  yPPSArmFDet2Info_ii.clear();

  xPPSArmBDet1Info_ii.clear();
  yPPSArmBDet1Info_ii.clear();

  xPPSArmFDet1Info_ii.clear();
  yPPSArmFDet1Info_ii.clear();

  tPPSArmFInfo_ii.clear();
  tPPSArmBInfo_ii.clear();

  xiPPSArmFInfo_ii.clear();
  xiPPSArmBInfo_ii.clear();
...
//----------------------------MC Gen Ifnfo---------------------
// MCGenInfo
void ExclusiveDijetsAnalysisUsingPPS_QCD::MCGenInfo(const edm::Event& iEvent, const edm::EventSetup& iSetup, bool debug)
{
...
void ExclusiveDijetsAnalysisUsingPPS_QCD::GenCollections(const edm::Event& iEvent, const edm::EventSetup& iSetup, bool debug)
{
...
/*
  ...
  if (protonLorentzVector.size() > 0 && protonLorentzVector.at(0).pz()<0.){
    ...
    math::XYZTLorentzVector vec_pi(0.,0.,-EBeam_,EBeam_);
    math::XYZTLorentzVector vec_pf(protonLorentzVector.at(1).px(),protonLorentzVector.at(0).py(),protonLorentzVector.at(0).pz(),protonLorentzVector.at(0).energy());
    math::XYZTLorentzVector vec_t = (vec_pf - vec_pi);
    ...
    if(debug){
      ...
      cout << " proton pZ ( proton 2):-> "  << protonLorentzVector.at(0).pz() << endl;
      cout << " proton py (proton 2):-> "  << protonLorentzVector.at(0).py() << endl;
      cout << " proton px (proton 2):-> "  << protonLorentzVector.at(0).px() << endl;
    }
...
void ExclusiveDijetsAnalysisUsingPPS_QCD::FillCollections(const edm::Event& iEvent, const edm::EventSetup& iSetup, bool debug)
{
...
if (pps_Flag_){
  ...
  if(ppsSpectrum->ArmB.ToFDet.HasStopped.size() > 0 && ppsSpectrum->ArmF.ToFDet.HasStopped.size() > 0){
	...
	if(iB == 0 && iF == 0 && ppsSpectrum->ArmB.ToF.at(0) != 0 && ppsSpectrum->ArmF.ToF.at(0) != 0 ){ 
	  ...
	  xPPSArmBToFInfo_00.push_back(xPPSArmBToFInfo[iB]);
	  yPPSArmBToFInfo_00.push_back(yPPSArmBToFInfo[iB]);

	  xPPSArmFToFInfo_00.push_back(xPPSArmFToFInfo[iF]);
	  yPPSArmFToFInfo_00.push_back(yPPSArmFToFInfo[iF]);


	  xPPSArmBDet2Info_00.push_back(xPPSArmBDet2Info[iB]);
	  yPPSArmBDet2Info_00.push_back(yPPSArmBDet2Info[iB]);

	  xPPSArmFDet2Info_00.push_back(xPPSArmFDet2Info[iF]);
	  yPPSArmFDet2Info_00.push_back(yPPSArmFDet2Info[iF]);

	  xPPSArmBDet1Info_00.push_back(xPPSArmBDet1Info[iB]);
	  yPPSArmBDet1Info_00.push_back(yPPSArmBDet1Info[iB]);

	  xPPSArmFDet1Info_00.push_back(xPPSArmFDet1Info[iF]);
	  yPPSArmFDet1Info_00.push_back(yPPSArmFDet1Info[iF]);

	  tPPSArmFInfo_00.push_back(tPPSArmFInfo[iF]);
	  tPPSArmBInfo_00.push_back(tPPSArmBInfo[iB]);

	  xiPPSArmFInfo_00.push_back(xiPPSArmFInfo[iF]);
	  xiPPSArmBInfo_00.push_back(xiPPSArmBInfo[iB]);	
	  /*

	     stopPPSArmFToFInfo_00.push_back(stopPPSArmFToFInfo[iF]);
	     stopPPSArmBToFInfo_00.push_back(stopPPSArmBToFInfo[iB]);

	     stopPPSArmFTrkDet1Info_00.push_back(stopPPSArmFTrkDet1Info[iF]);
	     stopPPSArmFTrkDet2Info_00.push_back(stopPPSArmFTrkDet2Info[iF]);
	     stopPPSArmBTrkDet1Info_00.push_back(stopPPSArmBTrkDet1Info[iB]);
	     stopPPSArmBTrkDet2Info_00.push_back(stopPPSArmBTrkDet2Info[iB]);
	   */
	  ...
	  deltaToF_00 = (ppsSpectrum->ArmB.ToF.at(iB)) - (ppsSpectrum->ArmF.ToF.at(iF));  
	  tof30ps_deltaToF_00 = (ppsSim->ArmB.ToF.at(iB)+smearToF1) - (ppsSim->ArmF.ToF.at(iF)+smearToF2); 
	  //cout << "iB " << iB << " iF " << iF << " vertexZPPS " << VertexZPPS <<  " deltaToF_00 " << deltaToF_00 << endl;
	...
	if((iB==0&&iF > 0 && ppsSpectrum->ArmB.ToF.at(0) != 0 && ppsSpectrum->ArmF.ToF.at(iF) != 0 )|| (iB > 0 && iF == 0 && ppsSpectrum->ArmB.ToF.at(iB) != 0 && ppsSpectrum->ArmF.ToF.at(0) != 0 )) {	  
	  ...
	  xPPSArmBToFInfo_0i.push_back(xPPSArmBToFInfo[iB]);
	  yPPSArmBToFInfo_0i.push_back(yPPSArmBToFInfo[iB]);

	  xPPSArmFToFInfo_0i.push_back(xPPSArmFToFInfo[iF]);
	  yPPSArmFToFInfo_0i.push_back(yPPSArmFToFInfo[iF]);


	  xPPSArmBDet2Info_0i.push_back(xPPSArmBDet2Info[iB]);
	  yPPSArmBDet2Info_0i.push_back(yPPSArmBDet2Info[iB]);

	  xPPSArmFDet2Info_0i.push_back(xPPSArmFDet2Info[iF]);
	  yPPSArmFDet2Info_0i.push_back(yPPSArmFDet2Info[iF]);

	  xPPSArmBDet1Info_0i.push_back(xPPSArmBDet1Info[iB]);
	  yPPSArmBDet1Info_0i.push_back(yPPSArmBDet1Info[iB]);

	  xPPSArmFDet1Info_0i.push_back(xPPSArmFDet1Info[iF]);
	  yPPSArmFDet1Info_0i.push_back(yPPSArmFDet1Info[iF]);

	  tPPSArmFInfo_0i.push_back(tPPSArmFInfo[iF]);
	  tPPSArmBInfo_0i.push_back(tPPSArmBInfo[iB]);

	  xiPPSArmFInfo_0i.push_back(xiPPSArmFInfo[iF]);
	  xiPPSArmBInfo_0i.push_back(xiPPSArmBInfo[iB]);

	  /*
	     stopPPSArmFToFInfo_0i.push_back(stopPPSArmFToFInfo[iF]);
	     stopPPSArmBToFInfo_0i.push_back(stopPPSArmBToFInfo[iB]);

	     stopPPSArmFTrkDet1Info_0i.push_back(stopPPSArmFTrkDet1Info[iF]);
	     stopPPSArmFTrkDet2Info_0i.push_back(stopPPSArmFTrkDet2Info[iF]);
	     stopPPSArmBTrkDet1Info_0i.push_back(stopPPSArmBTrkDet1Info[iB]);
	     stopPPSArmBTrkDet2Info_0i.push_back(stopPPSArmBTrkDet2Info[iB]);
	   */
	  ...
	  tof30ps_deltaToF_0i = (ppsSim->ArmB.ToF.at(iB)+smearToF1) - (ppsSim->ArmF.ToF.at(iF)+smearToF2);  
	  if(ppsSpectrum->ArmB.xi[iB] > 0. && ppsSpectrum->ArmF.xi[iF] > 0.){
	...
	if (iB > 0 && iF > 0 && ppsSpectrum->ArmB.ToF.at(iB) != 0 && ppsSpectrum->ArmF.ToF.at(iF) != 0 ) {	  
	  ...
	  xPPSArmBToFInfo_ii.push_back(xPPSArmBToFInfo[iB]);
	  yPPSArmBToFInfo_ii.push_back(yPPSArmBToFInfo[iB]);

	  xPPSArmFToFInfo_ii.push_back(xPPSArmFToFInfo[iF]);
	  yPPSArmFToFInfo_ii.push_back(yPPSArmFToFInfo[iF]);


	  xPPSArmBDet2Info_ii.push_back(xPPSArmBDet2Info[iB]);
	  yPPSArmBDet2Info_ii.push_back(yPPSArmBDet2Info[iB]);

	  xPPSArmFDet2Info_ii.push_back(xPPSArmFDet2Info[iF]);
	  yPPSArmFDet2Info_ii.push_back(yPPSArmFDet2Info[iF]);

	  xPPSArmBDet1Info_ii.push_back(xPPSArmBDet1Info[iB]);
	  yPPSArmBDet1Info_ii.push_back(yPPSArmBDet1Info[iB]);

	  xPPSArmFDet1Info_ii.push_back(xPPSArmFDet1Info[iF]);
	  yPPSArmFDet1Info_ii.push_back(yPPSArmFDet1Info[iF]);

	  tPPSArmFInfo_ii.push_back(tPPSArmFInfo[iF]);
	  tPPSArmBInfo_ii.push_back(tPPSArmBInfo[iB]);

	  xiPPSArmFInfo_ii.push_back(xiPPSArmFInfo[iF]);
	  xiPPSArmBInfo_ii.push_back(xiPPSArmBInfo[iB]);
	  /*

	     stopPPSArmFToFInfo_ii.push_back(stopPPSArmFToFInfo[iF]);
	     stopPPSArmBToFInfo_ii.push_back(stopPPSArmBToFInfo[iB]);

	     stopPPSArmFTrkDet1Info_ii.push_back(stopPPSArmFTrkDet1Info[iF]);
	     stopPPSArmFTrkDet2Info_ii.push_back(stopPPSArmFTrkDet2Info[iF]);
	     stopPPSArmBTrkDet1Info_ii.push_back(stopPPSArmBTrkDet1Info[iB]);
	     stopPPSArmBTrkDet2Info_ii.push_back(stopPPSArmBTrkDet2Info[iB]);
	  ...
	  tof30ps_deltaToF_ii = (ppsSim->ArmB.ToF.at(iB)+smearToF1) - (ppsSim->ArmF.ToF.at(iF)+smearToF2);  
	  if(ppsSpectrum->ArmB.xi[iB] > 0. && ppsSpectrum->ArmF.xi[iF] > 0.){
  ...
  if(PPSCMSVertexToF_00.size() > 0){
    for (unsigned int i=0;i<PPSCMSVertexToF_00.size();i++){
      if ((PPSCMSVertexToF_00[i].second == VertexVector[i]->z())){
	indexGoldToF_00 = i;
      }
    }
  }
  ...
  if(PPSCMSVertexToF_0i.size() > 0){
    for (unsigned int i=0;i<PPSCMSVertexToF_0i.size();i++){
      if ((PPSCMSVertexToF_0i[i].second == VertexVector[i]->z())){
	indexGoldToF_0i = i;
      }
    }
  }
  ...
  if(PPSCMSVertexToF_ii.size() > 0){
    for (unsigned int i=0;i<PPSCMSVertexToF_ii.size();i++){
      if ((PPSCMSVertexToF_ii[i].second == VertexVector[i]->z())){
	indexGoldToF_ii = i;
      }
    }
  }
...
void ExclusiveDijetsAnalysisUsingPPS_QCD::SortingObjects(const edm::Event& iEvent, const edm::EventSetup& iSetup, bool debug){
...
void ExclusiveDijetsAnalysisUsingPPS_QCD::AssociateJetsWithVertex(const edm::Event& iEvent, const edm::EventSetup& iSetup, bool debug){
 ...
 if(pps_Flag_) GoldenVertexZ = VertexVector[indexGold]->z();
  }
  for (unsigned int i=0;i<TracksVector.size();i++){
    if(indexGold != -999){
    if(pps_Flag_) MinimumDistance.push_back(fabs(VertexVector[indexGold]->z() - TracksVector[i]->innerPosition().Z()));
    }
  }
  ...
  // incluir aqui mais tarde a sugest�o do Diego sobre os tra�os fora do cone dos jatos usand como exemplo aqui:
  //https://github.com/ForwardGroupBrazil/ForwardAnalysis/blob/CMSSW_4_2_8_V04/ForwardTTreeAnalysis/src/ExclusiveDijetsAnalysis.cc#L323
  // para JetSameVector

  //http://www.cplusplus.com/reference/algorithm/stable_sort/
  stable_sort(DijetsVertexZPPSToF.begin(), DijetsVertexZPPSToF.end());
/*
if(pps_Flag_!=true){ // open flag
...
void ExclusiveDijetsAnalysisUsingPPS_QCD::ResolutionStudies(bool debug){
...
void ExclusiveDijetsAnalysisUsingPPS_QCD::PPSSelection(){
...
void ExclusiveDijetsAnalysisUsingPPS_QCD::setToFGeometry(std::string geotype)
{
  ToFCellRow.clear();
  ToFCellColumn.clear();
  if (geotype=="Quartic") {
...
void ExclusiveDijetsAnalysisUsingPPS_QCD::setQuartic()
{
...
int ExclusiveDijetsAnalysisUsingPPS_QCD::ToFCellId(double x, double y)
{
  int y_idx,x_idx;
...
void ExclusiveDijetsAnalysisUsingPPS_QCD::setToFParameters(std::string geo,double xpos)
{
...
void ExclusiveDijetsAnalysisUsingPPS_QCD::setBeamParameters(int pos, double x,double y,double rms_x,double rms_y)
{
  if (pos<1||pos>3) {
...
DEFINE_FWK_MODULE(ExclusiveDijetsAnalysisUsingPPS_QCD);
